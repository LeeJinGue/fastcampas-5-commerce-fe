...
const CheckCircleIcon = ({...props }) => {
  ...
  width={w+"px"} height={h+"px"} viewBox={`0 0 ${w} ${h}`} fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path d="M6.3894 11.7524L10.7304 15.9653L16.9984 8.61633" stroke="white" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
    </Icon>
  if(isIndeterminate) return <Icon
  width={w+"px"} height={h+"px"} viewBox={`0 0 ${w} ${h}`} fill="white" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path d="M23.25 12C23.25 5.7868 18.2132 0.75 12 0.75C5.7868 0.75 0.75 5.7868 0.75 12C0.75 18.2132 5.7868 23.25 12 23.25C18.2132 23.25 23.25 18.2132 23.25 12Z" stroke="#FF710B" stroke-width="1.5"/>
    <path d="M6.3894 11.7524L10.7304 15.9653L16.9984 8.61633" stroke="#FF710B" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
    </Icon>
  ...
  width={w+"px"} height={h+"px"} viewBox={`0 0 ${w} ${h}`} fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path d="M6.3894 11.7524L10.7304 15.9653L16.9984 8.61633" stroke="#CBCED6" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
    </Icon>
};
