...
import { Box, ChakraProps, Button, Flex, Image, Text, BoxProps, FlexProps, useToast } from '@chakra-ui/react';
        ...
        return <Flex flexDir="column" key={orderStatus.id}>
          ...
          {shippingStatus && shippingStatus === "PAID" ?
            ...
            <PrimaryButton
              mt="10px" mb="20px" mr="16px"
              alignSelf="end" w="140px" h="40px"
              btntype={'Solid'} btnstate={'Primary'} btnshape={'Rectangle'} onClick={() => handleCancelOrder()}>
              주문취소
            </PrimaryButton>
          }
        </Flex>
